...
<html lang="en">
  <head>
    ...
    <title>REGISTER SIAKAD STMIK SZNW</title>
    <!-- Simple bar CSS -->
    ...
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form action="/registeruser" method="post" class="col-lg-3 col-md-4 col-10 mx-auto text-center">
          ...
          <h1 class="h4 mb-3">Register here</h1>
          <div class="form-group">
            <label for="name" class="sr-only">Name</label>
            <input type="text" id="name" class="form-control form-control-lg" placeholder="name" name="name" required="">
          </div>
          <div class="form-group">
